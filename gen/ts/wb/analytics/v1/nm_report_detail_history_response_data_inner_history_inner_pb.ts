...
// @generated from file wb/analytics/v1/nm_report_detail_history_response_data_inner_history_inner.proto (package wb.analytics.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message wb.analytics.v1.NmReportDetailHistoryResponseDataInnerHistoryInner
 */
export class NmReportDetailHistoryResponseDataInnerHistoryInner extends Message<NmReportDetailHistoryResponseDataInnerHistoryInner> {
  /**
   * Дата
   *
   ...
   *
   * @generated from field: float addToCartConversion = 9;
   */
  ...
  constructor(data?: PartialMessage<NmReportDetailHistoryResponseDataInnerHistoryInner>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "wb.analytics.v1.NmReportDetailHistoryResponseDataInnerHistoryInner";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 9, name: "addToCartConversion", kind: "scalar", T: 2 /* ScalarType.FLOAT */ },
    { no: 10, name: "cartToOrderConversion", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): NmReportDetailHistoryResponseDataInnerHistoryInner {
    return new NmReportDetailHistoryResponseDataInnerHistoryInner().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): NmReportDetailHistoryResponseDataInnerHistoryInner {
    return new NmReportDetailHistoryResponseDataInnerHistoryInner().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): NmReportDetailHistoryResponseDataInnerHistoryInner {
    return new NmReportDetailHistoryResponseDataInnerHistoryInner().fromJsonString(jsonString, options);
  }

  static equals(a: NmReportDetailHistoryResponseDataInnerHistoryInner | PlainMessage<NmReportDetailHistoryResponseDataInnerHistoryInner> | undefined, b: NmReportDetailHistoryResponseDataInnerHistoryInner | PlainMessage<NmReportDetailHistoryResponseDataInnerHistoryInner> | undefined): boolean {
    return proto3.util.equals(NmReportDetailHistoryResponseDataInnerHistoryInner, a, b);
  }
}
