...
// @generated from file wb/promotion/v1/response_with_date_inner.proto (package wb.promotion.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message wb.promotion.v1.ResponseWithDateInner
 */
export class ResponseWithDateInner extends Message<ResponseWithDateInner> {
  /**
  ...
  constructor(data?: PartialMessage<ResponseWithDateInner>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "wb.promotion.v1.ResponseWithDateInner";
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ResponseWithDateInner {
    return new ResponseWithDateInner().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ResponseWithDateInner {
    return new ResponseWithDateInner().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ResponseWithDateInner {
    return new ResponseWithDateInner().fromJsonString(jsonString, options);
  }

  static equals(a: ResponseWithDateInner | PlainMessage<ResponseWithDateInner> | undefined, b: ResponseWithDateInner | PlainMessage<ResponseWithDateInner> | undefined): boolean {
    return proto3.util.equals(ResponseWithDateInner, a, b);
  }
}
