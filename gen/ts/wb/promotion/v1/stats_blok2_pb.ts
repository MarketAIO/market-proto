...
// @generated from file wb/promotion/v1/stats_blok2.proto (package wb.promotion.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, proto3 } from "@bufbuild/protobuf";
import { DailyStats2Inner } from "./daily_stats2_inner_pb.js";

/**
 * @generated from message wb.promotion.v1.StatsBlok2
 */
export class StatsBlok2 extends Message<StatsBlok2> {
  /**
   * ID баннера
   *
  ...
  /**
   * @generated from field: repeated wb.promotion.v1.DailyStats2Inner daily_stats = 18;
   */
  dailyStats: DailyStats2Inner[] = [];
  ...
  constructor(data?: PartialMessage<StatsBlok2>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "wb.promotion.v1.StatsBlok2";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 18, name: "daily_stats", kind: "message", T: DailyStats2Inner, repeated: true },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): StatsBlok2 {
    return new StatsBlok2().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): StatsBlok2 {
    return new StatsBlok2().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): StatsBlok2 {
    return new StatsBlok2().fromJsonString(jsonString, options);
  }

  static equals(a: StatsBlok2 | PlainMessage<StatsBlok2> | undefined, b: StatsBlok2 | PlainMessage<StatsBlok2> | undefined): boolean {
    return proto3.util.equals(StatsBlok2, a, b);
  }
}
